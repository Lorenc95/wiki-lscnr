...
- Verbally insults you, or your crew. (In VC or in Chat) - Make sure to have a clip of this when it does happen to avoid false bans.
...
Using any modification, external program, or third-party tool that gives you an unfair advantage is not allowed.

| Category | Not Allowed |
|---|---|
| **Gameplay-altering tools** | Mod menus, wallhacks, noclip, health lock, damage modifiers, recoil scripts, rapid fire tools, triggerbots, aim assistance, cheat menus, softaim, etc.. |
| **Visual/world mods** | Ragdoll physics changes, object removal, foliage/prop removal (leaves, bushes, water, electrical cabinets, phone booths, etc.), collision removal, weather changes |
...
| **Weapon Mods** | using RPF mods that change the way weapons are supposed to behave in any way |
| **Texture Mods** | Texture mods	Anything that makes camouflage, ghillie suits, or hidden players easier to spot |
| **HUD/minimap mods** | Extended radar range, player blips beyond normal detection radius |
| **Vehicle/physics exploits** | Noclip, teleport hacks, infinite handbrake/traction glitches used to cheese chases |

> ⚠️ **Don't cheat or mod you will be banned and your progress may be reset.**
...
| **Static crosshair overlay** | A simple static crosshair that does not read game memory, automate inputs, or provide any advantage beyond a visual overlay. If it does more than display a static crosshair, treat it as **not allowed** unless staff confirm otherwise |
...
| **Graphics enhancement packs** | Graphic packs, that dont give you an unfair advantage - FPS packs are fine if they dont remove objects water etc.. |
| **Skydome** | Custom skydomes are completely fine and allowed. |
| **Tracers** | Customs Tracers are allowed. |
| **Weather mods** | Mods that change weather are fine, aslong as they dont provide you with an unfair advantage |
| **No Shadows** | Also allowed as all this does is provide an improvement in fps, and does not give a real advantage |


Staff may determine whether a specific modification is allowed on a case-by-case basis, if they deem a mod not allowed that is not explicitly listed above you may still be banned for it.
