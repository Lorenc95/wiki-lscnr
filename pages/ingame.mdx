...
- **Constant yapping** — nonstop mic spam, talking over everyone, refusing to shut up when asked, dominating voice in a disruptive way
...
- **Red-name bounty** — you approach a player who has a **red name** and an **active bounty**. The bounty *is* the reason. You do not need to wait to be shot at first.
...
- You shoot a green-name player with **no bounty, no initiation, no redzone, and no active scene** justifying it
