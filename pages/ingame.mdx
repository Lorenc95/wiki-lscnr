...
- No RDM — do not attack or kill people without a valid reason. See the RDM section for valid-kill situations (red-name bounties, blue-name hits, initiation, redzones/airdrop, active robbery scenes).
...
- No teaming across sides. Cops and criminals do not work together, with one narrow exception for police transport.
...
- Persistent negative behavior that hurts the community can get you permanently removed.
...
### Rule 3 — Excessive toxicity / provocation
...
### Rule 5 — Persistent negative behavior
...
- **Red-name bounty** — a player with an active bounty and red name is in open PvP. Anyone may engage them without further justification, and they may engage anyone in return — no initiation needed from either side. A bounty player killing a white-name player is not RDM. There is no such thing as being protected from a bounty player; the bounty makes the situation open on both ends.
- **Blue-name hit** — a player with an active hit on them shows a bright blue blip and name. This works identically to a bounty: anyone may engage them, and they may engage anyone in return. No initiation needed from either side. Killing a hit target is not RDM, and a hit target killing others is not RDM.
...
- You shoot a white-name player with no bounty, no hit, no initiation, no redzone, and no active scene justifying it
...
- **Revenge killing** — you got killed in a valid situation (bounty, hit, redzone, active scene, etc.) and then go hunt that player down after the situation ended. The fight is over when the fight is over. If they are no longer red-name/bountied, no longer a blue-name hit target, no longer in the redzone, and no longer part of an active scene, shooting them again is RDM.
...
After any of these, you are back to needing a fresh valid reason (new bounty, new hit, new redzone entry, new scene, new initiation) to engage that player again.
...
### Rule 7 — Vehicle combat & fair fights
...
### Rule 9 — Kill feeding & manipulating outcomes
...
## Category 3 — Cheating & Exploits

### Rule 12 — Cheating and exploits
...
### Rule 13 — Macros, scripts, and overlays
...
### Rule 14 — Game modifications and visual advantage mods
...
### Rule 15 — Spawn and revive protection
...
### Rule 16 — Ghost peeking

Do not abuse cover so bullets pass through walls in ways that are not fair normal gameplay.

**What is NOT ghost peeking:** Some vehicles have asymmetric collision — for example, a car where the player can shoot out the back window, but bullets cannot pass through that same window going in. This is not ghost peeking and is not a punishable offense for the driver.
...
## Category 4 — Meta & Streaming

### Rule 20 — Meta gaming and stream sniping
...
### Rule 22 — Accounts, alts, and ban evasion
...
## Category 6 — Reports & Staff

### Rule 23 — Player reports and evidence
...
- open tickets for situations that are clearly covered as valid kills (see Rule 6 — red-name bounty, blue-name hit, initiation, redzone/airdrop, active robbery scene)
...
### Rule 24 — Rule interpretation and fair play
...
### Rule 25 — Staff authority and discretion
