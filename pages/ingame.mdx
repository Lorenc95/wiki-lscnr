...
- **No RDM**, do not attack or kill players without a valid reason. Valid reasons are: red-name (5-star wanted level), initiation, redzones, airdrop zone, active robbery scenes, and the EMS engagement rules.
...
- **No combat logging**, do not disconnect or kill yourself to escape consequences, except when an EMS player is unlawfully attempting to kill you.
- **No teaming** across sides. Cops, criminals, paramedics, and tow drivers each have their own rules.
- **EMS must remain neutral**, except where these rules explicitly allow intervention.
...
**The points above are only a summary. The full rules below are the final authority and always take precedence. It is every player's responsibility to stay up to date with the complete rules.**
...
| **EMS**                  | Emergency Medical Services. Paramedics are neutral emergency responders who provide medical assistance and may only use force where these rules explicitly permit it. |
...
### d. Civilians and paramedics

When playing as a civilian or criminal, you may attack or kill a paramedic if the paramedic is:

- Reviving an enemy or opponent.
- Healing an enemy or opponent.
- Staying or moving close enough to enemies/opponents that they are able to revive them.
- Moving toward your location and getting within assault rifle range while there are enemies/opponents nearby that could be revived.

Additional rules:

- You cannot force EMS to work for you by taking them hostage.
- You may intimidate EMS to stop them from reviving your enemies.
- You cannot kill EMS simply because they revived your friend.
- Randomly attacking or killing EMS is RDM.
