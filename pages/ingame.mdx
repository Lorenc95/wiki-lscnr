...
| **Cheats** | Common sense applies here; if its not meant to be used and gives you a benefit over other players in terms of gameplay other then visual mods, its not allowed unless EXPLICITLY listed below. |
