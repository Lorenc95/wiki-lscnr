...
See Rule 18 (Cop Hunting) for how these rules apply to unwanted players engaging cops.
...
LSCnR does not have "cop hunting" as a separate mechanic. Engaging a police officer is governed entirely by the RDM rules in Rule 1, not by the fact that they are a cop.
...
- Having a wanted level does not make every cop on the server a valid target. It only gives you initiation on officers actively engaging you as described in Rule 1c — not on cops elsewhere who are uninvolved.

Attacking cops with no wanted level, or attacking cops that have not engaged you, will be treated as RDM under Rule 1.
