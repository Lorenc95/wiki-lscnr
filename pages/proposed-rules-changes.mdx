...
9. [Meta Gaming & Stream Sniping](#9-meta-gaming--stream-sniping)
10. [Star Baiting](#10-star-baiting)
11. [Emotes](#11-emotes)
12. [Ghost Peeking](#12-ghost-peeking)
13. [Safe Zones](#13-safe-zones)
14. [Clothing](#14-clothing)
15. [Kill Feeding](#15-kill-feeding)
16. [Persistent Negative Behavior](#16-persistent-negative-behavior)
17. [Bug Reports](#17-bug-reports)
18. [Minimum Age](#18-minimum-age)
...
| **Most Wanted** | The single player currently holding the highest active bounty on the server. Their name and blip appear **dark red**. Only one player holds this status at a time. |
...
| **Wanted level / Stars** | A scripted mechanic reflecting a player's criminal activity. At 5 stars the player's name turns red and they become KOS. |
...
**Most Wanted**
The Most Wanted player is the single player currently holding the highest active bounty on the server. Their name and blip appear **dark red**. Only one player holds this status at a time, and they are KOS for all players — no initiation required.

If you are the Most Wanted player, you have the same self-defense rights as a red-name bounty player. You may kill any player visibly approaching you with clear hostile intent. A player who happens to be nearby without showing hostile intent is not a valid target.
...
If you have an active hit on you at any tier, you have the same self-defense rights as a red-name bounty player. You may kill any player visibly approaching you with clear hostile intent. A player who happens to be nearby without showing hostile intent is not a valid target.
...
During any robbery in progress — store, bank, jewelry heist, or any other robbery job — all players present at the scene are valid targets. This applies whether or not police are online or responding. Criminals defending the robbery and any players who arrive at the scene are engaging on their own terms. Bystanders who enter an active scene accept the risk of being engaged.
...
This applies to tow drivers as well — having your vehicle towed counts as having your property taken, regardless of whether it was done as part of a job.
...
Safe zones do not protect players with an active wanted level. Cops may engage and arrest wanted players inside a safe zone. Other players may not RDM a wanted player inside a safe zone — but cops performing their duties are not committing RDM.
